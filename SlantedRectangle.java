...
public class SlantedRectangle extends Rectangle {
    ...
    public boolean contains(Point p) {
        ...
        // Rotation inverse pour ramener le point dans le système de coordonnées du rectangle
    ...
    public boolean contains(Rectangle r) {
        // Un rectangle incliné contient un autre rectangle si tous ses coins sont à l'intérieur
        if (r instanceof SlantedRectangle) {
            SlantedRectangle sr = (SlantedRectangle) r;
    ...
    public boolean contains(SlantedRectangle sr) {
      ...
      // Redéfinition de la méthode hull pour prendre en compte les rectangles inclinés
