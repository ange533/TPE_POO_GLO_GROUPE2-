public class SlantedRectangle extends Rectangle {
    ...
    public boolean contains(Point p) {
        ...
        // On retranslate le point pour retrouver les coordonnées dans le repère du rectangle non incliné
        float finalX = rotatedX + centerX;
        float finalY = rotatedY + centerY;
        
        // On crée un point "redressé" et on utilise la méthode contains du rectangle parent
    ...
    public boolean equals(Rectangle r) {
        if (!(r instanceof SlantedRectangle)) {
            return false; // Ce n'est pas un rectangle incliné
        }
        
        SlantedRectangle sr = (SlantedRectangle) r;
        
        // Égalité si même point, mêmes dimensions et même angle
    ...
    public String toString() {
        return "SlantedRectangle [point=" + getPointbasgauche() + ", largeur=" + getLargeur() 
               + ", hauteur=" + getHauteur() + ", angle=" + angle + " radians]";
    }
}